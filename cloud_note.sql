...
select cn_note_status_id from cn_note;
...
-- ----------------------------
INSERT INTO `cn_note_status` VALUES ('0', 'normal', 'normal');
INSERT INTO `cn_note_status` VALUES ('1', 'recycleBin', 'recycleBin');
commit;

select * from cn_note_status;
